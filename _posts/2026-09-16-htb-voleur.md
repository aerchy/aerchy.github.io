...
tags: [htb, windows, active-directory, bloodhound, netexec, smbclient, kerberos, office2john, john, dpapi, wsl, secretsdump, kerberoasting, kinit, evil-winrm, targeted-kerberoasting, runascs, msfvenom, meterpreter, scp, ad-recycle-bin, ntds-dit, writespn]
